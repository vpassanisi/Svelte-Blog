...
<div class="border-2 rounded mt-24 p-4 max-w-screen-md mx-auto">
  <div
    ...
    <div class="flex flex-wrap justify-center">
      <div class="flex flex-col items-center justify-center">
        ...
        <div id="oscAFrequencyKnob" class="relative h-12 w-12">
          ...
          <div
            class="absolute top-0 h-12 w-12 left-0 bg-light-blue-400 border-4
            border-gray-400 rounded-full box-border range-knob" />
        </div>
        <input
  ...
  <div
    class="border-2 rounded flex flex-wrap items-center justify-center p-4
    focus:outline-none">
    <button
      on:mousedown={() => {
    ...
    <button
      ...
      black-keys bg-black z-10 focus:outline-none">
      A#
      <small>4</small>
    </button>
    <button
